...
function renderCards() {
  ...
  filtered.forEach(function(c) {
    ...
    div.className = 'clientCard clientCard-neon clientCard-c-' + visualState;
    div.innerHTML =
      ...
      '<div class="clientCard-actions clientCard-actions-clean">' +
        ...
        '<button class="act-more" data-id="'+c.id+'" onclick="openClientMoreActions(this.dataset.id)" aria-label="Más opciones">&#8942;</button>' +
      '</div>';
