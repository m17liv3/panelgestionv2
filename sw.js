const CACHE_NAME = 'm17liv3-client-delete-visible-v2-20260726';
const APP_SHELL = [
  './',
  './index.html',
  './cartelera.html',
  './styles.clientes-expandibles-delete-visible-v2-20260726.css',
  './script.clientes-expandibles-delete-visible-v2-20260726.js',
  './config.js',
