const CACHE_NAME = 'm17liv3-client-more-delete-only-v3-20260726';
const APP_SHELL = [
  './',
  './index.html',
  './cartelera.html',
  './styles.clientes-expandibles-more-delete-only-v3-20260726.css',
  './script.clientes-expandibles-more-delete-only-v3-20260726.js',
  './config.js',
