const CACHE_NAME = 'm17liv3-renew-amount-required-v4-borrar-force-mensajes-editables-mensajes-editables-force-balance-finanzas-balance-finanzas-k13-jordan-finance-date-fix-finanzas-mas-anos-balance-ano-completo-msg-duplicate-fix-final-graficas-etiquetas-avisos-v2-etiquetas-finales-dos-sin-avisos-historial-renovaciones-recordar-dispositivo-mfa-login-rapido-sin-mfa-sin-menu-google-authenticator-whatsapp-renovar-graficas-inicio-sin-rapido-sin-whatsapp-diseno-premium-nav-confirm-toast-custom-limpieza-respuesta-settings-sync-colores-respuesta-renovacion-clientes-deslizar-buscador-clientes-deslizar-home-opcion1-fix-ver-mas-home-home-panel-estado-home-limpio-sin-duplicados-pagos-pendientes-solo-pagado-generador-cartelera-diaria-prompt-chatgpt-cartelera-logo-borrar-prompt-sin-logo-con-borrar-caducan-pronto-acciones-sin-personalizar-app-caducan-pronto-no-contestado-caducan-pronto-tags-completos-paneles-editables-paneles-sync-fix-paneles-open-sync-fix-paneles-mobile-cargando-fix-promps-section-promps-evento-texto-promps-textarea-dark-promps-event-upload-promps-upload-evento-dia-cart-clear-event-img-clientes-borrar-btn-promps-extra-generador-promps-extra-visible-promps-extra-inside-sheet-promps-pelis-series-img-fix-promps-all-image-premium-sin-generador-rapido-promps-ficha-premium-calendario-renovaciones-calendario-sin-ficha-premium-fix-editar-ficha-calendario-fix-pelicula3-definitivo';
const APP_SHELL = [
  './',
  './index.html',
  './styles.css',
