const CACHE_NAME = 'm17liv3-safe-spacing-v5-20260726';
const APP_SHELL = [
  './',
  './index.html',
  './cartelera.html',
  './styles.clientes-expandibles-safe-spacing-v5-20260726.css',
  './script.clientes-expandibles-safe-spacing-v5-20260726.js',
  './config.js',
